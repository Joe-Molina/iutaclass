                  ...
                  conn.query(
                    ...
                    (err, userdata) => {
                      ...
                      console.log(userdata)
                            ...
                            res.render('calificar', { aulas: userdata, session: req.session, vista, calificarvista,calificaciones: false, unidades:false})             
                    ...
                    (err, userdata) => {
                      ...
                      conn.query(
                        ...
                        (err, unidades) =>{
                            ...
                            const vista = "calificar"
                            const calificarvista = true
                            res.render('calificar', { aulas: userdata, session: req.session, vista, calificarvista,calificaciones: false, unidades})
                        }
                      )
                  ...
                  conn.query(
                    ...
                    (err, evaluacionesData) =>{
                      ...
                      //calificacion
                        ...
                        const vista = "calificar"
                        const calificarvista = true
                        res.render('calificar', { aulas: userdata, session: req.session, vista, calificarvista, calificaciones: evaluacionesData,unidades:false })
